;(function () {
  ...
  Controls.manageIndexes = function (controlNode, params) {
    var indexFunctions = {
      'Create index': function () {
        Swals.createIndex(params)
      },
      'Existing indexes': function () {
        Swals.showIndexes(params)
      },
    }

    UI.select(Object.keys(indexFunctions), {
      parent: controlNode,
      id: 'index-actions',
      firstRowText: 'Indexes',
      style: {
        margin: '10px'
      }
    }, function (r) {
      indexFunctions[r]()
      document.querySelector('select#index-actionsSelect > option').selected = true
    })
  }
  ...
  Controls.getSchema = function (cb) {
